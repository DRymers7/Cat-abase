...
public class DogPicService {
    ...
    public DogApiResponse getDogPicture(String breed) throws GenericProducerServerException {
        try {
            ...
            throw new GenericProducerServerException("Could not get picture of dog.");
        }
    }
